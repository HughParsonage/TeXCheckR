...
Educational researchers have long contested how school funding affects student achievement, and this literature is reviewed in \Vref{chap:appendix-2-do-extra-funds-improve-student-results}.
...
A detailed summary of the program evaluations are included in \Cref{chap:appendix-2-do-extra-funds-improve-student-results}.
\end{smallbox}
...
We make a single set of assumptions about the indexation contributed by states, consistent with recent trends in DET data (see \Vref{chap:appendix-3-contributions-of-commonwealth-and-state-governments}).
...
This is discussed further in \Chapref{chap:costing-the-compact} and in \Vref{chap:appendix-3-contributions-of-commonwealth-and-state-governments}.
...
For further discussion on state and Commonwealth funding growth rates to date see \Vref{chap:appendix-3-contributions-of-commonwealth-and-state-governments}.
