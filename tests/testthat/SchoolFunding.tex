...
Goss, P., Sonnemann, J., Griffiths, K., and Chivers, C., 2016, Circuit breaker: a new compact for school funding, Grattan Institute
...
\recommendation{Achieve needs-based funding by 2023}\label{recommendation-1-achieve-needs-based-funding-by-2023}
...
\recommendation{Strengthen governance of school funding}\label{recommendation-2-strengthen-governance-of-school-funding}
...
\recommendation{Redirect the savings to invest in highly skilled teachers}\label{recommendation-3-re-direct-the-savings-to-invest-in-highly-skilled-teachers-to-lift-the-effectiveness-of-the-workforce}
\begin{itemize}
...
\section{Why focus on school funding?}\label{why-focus-on-school-funding}
...
\subsection{Changes in spending over the last decade }\label{changes-in-spending-over-the-last-decade}
...
\subsection{Ignore the hype: Australia is not a big spender in education }\label{ignore-the-hype-australia-is-not-a-big-spender-in-education}
\begin{figure}
...
\subsection{Emerging evidence shows investments in education can improve outcomes -- when spent well}\label{emerging-evidence-shows-investments-in-education-can-improve-outcomes}

Educational researchers have long contested how school funding affects student achievement, and this literature is reviewed in \Vref{appendix-2-do-extra-funds-improve-student-results}.
...
\subsection{Schools must spend money wisely, and the policy settings must be right}\label{Schools-and-governments must spend money wisely}
...
A detailed summary of the program evaluations are included in \Cref{appendix-2-do-extra-funds-improve-student-results}.
\end{smallbox}
...
\section{The principles of needs-based funding}\label{the-principles-of-needs based-funding}
...
\section{The recent history of needs-based funding}\label{politics-has-got-in-the-way-of-good-policy}
...
\subsection{The Gonski review proposed a new model}\label{the-gonski-principles-should-be-the-goal}
...
But in practice, the SRS fails to do so. There are problems in how the SRS is calculated (see \Cref{Selecting-an-appropriate-funding-base-rate}).
...
\subsection{Transitional arrangements to the SRS have stalled }\label{transitional-arrangements-to-the-srs-have-stalled}
...
\section{Funding is still not directed to where it can have the greatest impact}\label{current-situation-funding-is-still-not-directed-to-where-it-can-have-the-greatest-impact}
...
\subsection{Most school systems are underfunded relative to their targets}\label{most-school-systems-are-under-funded}
...
\subsection{Many individual schools are under-funded }\label{most-schools-are-under-funded}
...
\subsection{Some schools are extremely over-funded}\label{some-schools-are-extremely-over-funded}
...
\section{The current targets are a large unfunded liability}\label{needs-based-funding-is-now-a-large-unfunded-liability}
...
\subsection{Commitments to needs-based funding}\label{commitments-to-needs-based-funding}
...
\subsection{The size of the gap between actual funding and the current definition of needs-based funding }\label{siz-of-the-gap-between-actual-funding-and-the-current-definition}
...
\subsection{Selecting an appropriate funding base rate} \label{Selecting-an-appropriate-funding-base-rate}
...
Emerging evidence shows that funding tends to have a greater impact when it is targeted to educational need, as discussed in \Vref{emerging-evidence-shows-investments-in-education-can-improve-outcomes}.
...
\pagebreak[3]
\section{Transitioning to target levels of funding}\label{The-current-transition-arrangements-will-take-a-long-time}
...
Yet even with the higher indexation rate, some schools below SRS will take a very long time to catch up to their targets (see \Vref{some-underfunded-schools-still-below-target-even-in-a-decade}).

\begin{figure}
\caption{Under the 2013 Education Act, the most under-funded schools will still be funded well below their SRS target even in a decade}\label{some-underfunded-schools-still-below-target-even-in-a-decade}
...
\begin{figure}
\caption{Under the 2013 Education Act, over-funding will persist until the end of the century
\label{fig:overfunding-will-persist-until-end-of-century}}
...
\section{The Commonwealth's proposal to equalise funding across states could create perverse outcomes}\label{equalise-funding-across-states}
...
\section{Better governance is required}\label{the-srs-formula-must-be-reviewed-and-governance-arrangements-strengthened}
...
\Vref{Selecting-an-appropriate-funding-base-rate}.
...
\section{School funding should grow in line with wages growth}\label{school-funding-should-grow-in-line-with-wages-growth}
...
\section{Legislated Commonwealth indexation rates are too high }\label{legislated-commonwealth-indexation-rates-are-too-high}
...
\section{The 2016 Budget set new indexation rates that create new problems}\label{the-2016-budget-set-new-indexation-rates-that-create-new-problems}
...
\section{Neither the 2013 nor the 2016 path works, and political problems loom}\label{neither-the-2013-nor-the-2016-path-works-and-political-problems-loom}
...
The compact we propose is based on the principles outlined in \Vref{Six-principles-behind-the-new-compact}, which should be widely supported.

\begin{verysmallbox}{Six principles behind the new compact:}{box:5-principles-behind-new-compact}\label{Six-principles-behind-the-new-compact}
...
\addindentchap{Part~A: Deliver needs-based funding}\label{part-a-achieving-needs-based-funding}

\section{Overview of key concepts}\label{overview-of-key-concepts}
...
\section{The four steps to achieve needs-based funding}\label{details-of-the-four-steps-to-achieve-needs-based-funding}
...
\subsection{Reduce the indexation rate of the SRS target}\label{i-reduce-the-indexation-rate-of-the-srs-target}
...
Today, annual growth in the Education Wage Price Index is about 2.5~per cent and is expected to stay low for some time (\Vref{school-funding-should-grow-in-line-with-wages-growth}).
...
\subsection{Reduce indexation rates on annual funding}\label{ii-reduce-indexation-rates-on-annual-funding}
...
We make a single set of assumptions about the indexation contributed by states, consistent with recent trends in DET data (see \Vref{appendix-3-contributions-of-commonwealth-and-state-governments}).
...
\subsection{Reduce funding to highly over-funded schools}\label{iii-reduce-funding-to-highly-over-funded-schools}
...
\subsubsection{Small but symbolically important savings }\label{small-but-symbolically-important-savings}
...
\subsection{Provide top-up payments for very under-funded schools}\label{iv-provide-top-up-payments-for-highly-under-funded-schools}
...
\subsection{State contributions}\label{some-state-governments-will-need-to-step-up}
...
This is discussed further in \Chapref{chap:costing-the-compact} and in \Vref{appendix-3-contributions-of-commonwealth-and-state-governments}.

\section{Getting resourcing right is only the first step -- broader reforms are needed to teaching and learning}\label{getting-resourcing-right-is-only-the-first-step-broader-reforms-are-needed-to-teaching-and-learning}
...
\addindentchap{Part~B: Invest in highly skilled teachers}\label{part-b-investing-more-in-highly-skilled-teachers}
...
\section{The way teaching is organised needs to change}\label{the-way-teaching-is-organised-needs-to-change}
...
\subsection{Career structures do not make the most of skilled teachers -- unlike high performing systems overseas}\label{career-structures-do-not-make-the-most-of-skilled-teachers-unlike-high-performing-systems-overseas}
...
\subsection{Some Australian approaches have helped share teaching expertise -- but more impetus is needed}\label{some Australian-approaches--open-up-access-to-expertise---but-more-impetus-is-needed}
...
\section{Under the compact: Two new roles for highly skilled specialist teachers}\label{under-the-compact-two-new-roles-for-highly-skilled-specialist-teachers}
...
\subsubsection{Role 1: Master Teachers build expertise across schools}\label{role-1-master-teachers-who-work-across-schools}
...
\subsubsection{Role 2: Instructional Leaders work intensively with teachers in their own school}\label{role-2-instructional-leaders-work-intensively-with-teachers-in-their-school}
...
\subsection{Helping more schools to improve through feedback }\label{helping-more-schools-to-improve-through-feedback}
...
\subsection{Distinguishing features of the new positions}\label{distinguishing-features-of-the-new-positions}
...
\section{For the Commonwealth government}\label{for-the-commonwealth}
...
This would require major and irresponsible cuts to school funding that are unlikely to be passed by the Senate (see \Vref{neither-the-2013-nor-the-2016-path-works-and-political-problems-loom}).
...
\section{For state and territory governments}\label{for-state-and-territory-governments}
...
For further discussion on state and Commonwealth funding growth rates to date see \Vref{appendix-3-contributions-of-commonwealth-and-state-governments}.
...
\chapter{Do extra funds improve student results?}\label{appendix-2-do-extra-funds-improve-student-results}
...
%\section{International studies}\label{international-studies}
\section{Older and less robust studies}\label{criticism-of-older-studies}
...
\section{Australian studies}\label{australian-studies}
The evolution of analytical approaches internationally is reflected by Australian studies.
\subsubsection{Aggregate studies}\label{aggregate-studies}
...
\subsubsection{Evaluations of the Smarter Schools National Partnerships}\label{the-smarter-schools-national-partnerships}
...
\subsubsection{Early Action for Success}\label{early-action-for-success}
...
\chapter{Contributions of Commonwealth and state governments}\label{appendix-3-contributions-of-commonwealth-and-state-governments}
...
\section{Most school funding comes from the states}\label{most-school-funding-comes-from-the-states}
...
\section{Commonwealth funding has grown rapidly in recent years}\label{commonwealth-funding-has-been-growing-rapidly-in-recent-years}
...
\section{State funding growth is unclear}\label{state-funding-growth-is-unclear}
